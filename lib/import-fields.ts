...
export const IMPORT_FIELDS = [
  ...
  { key: "custoMensal", label: "Custo mensal", required: false },
  { key: "diaVencimento", label: "Dia de vencimento (1-31)", required: false },
  { key: "dataRenovacao", label: "Data de renovação (hospedagem)", required: false },
  { key: "valorRenovacao", label: "Valor da renovação", required: false },
