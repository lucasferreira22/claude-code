...
function guessMapping(headers: string[]): Record<ImportFieldKey, string> {
  ...
  const hints: Record<ImportFieldKey, string[]> = {
    ...
    valorMensal: ["valor mensal", "mensalidade", "fee"],
    custoMensal: ["custo", "despesa"],
    diaVencimento: ["dia de venc", "vencimento", "dia venc"],
    dataRenovacao: ["renova", "renovacao"],
    valorRenovacao: ["valor da renova", "valor renova"],
